...
// --- libraries ------------------
TString local_fastjet_path="/usr/lib/x86_64-linux-gnu";
TString local_cgal_path="/usr/lib";
TString loaddylibs=("");
TString loadlibs=("libCGAL libfastjet libsiscone libsiscone_spherical libfastjetplugins libJETAN libFASTJETAN libPWGTools libPWGflowBase libPWGflowTasks libPWGmuon libPWGHFbase libPWGHFvertexingHF libFASTJETAN libPWGJE");
