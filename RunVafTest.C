void RunVafTest(){
  ...
  TString alilibs("STEERBase:ESD:AOD:ANALYSIS:OADB:ANALYSISalice:CORRFW:PWGTools:PWGLFforward2:PWGHFbase:PWGflowBase:PWGflowTasks:PWGHFvertexingHF:PWGJE");
  // Here FASTJET stuff
  TString fastjetlibs("");
...
void AddTaskJetFinder(){
  ...
  taskCl = AddTaskJetCluster("AOD","",kHighPtFilterMask,iPhysicsSelectionFlag,"UA1",0.4,0,kTRUE,"",0.15,fTrackEtaWindow);
